        ...
        <section className='mb-12'>
            ...
            <div className='sm:flex'>
                ...
                <div className='flex-1 '>
                    <p className='text-[13px] mb-10 sm:text-[15px] sm:pt-2'>We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people.
